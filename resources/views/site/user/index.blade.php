                        ...
                        <ul>
                            <li class="item-action">
                                <a href="" data-url="{{route('site.user.account.profile')}}" class="change_data_view">Tài
                                    ...
                                    của tôi</a>
                                <ul>
                                    <li><a href="" data-url="{{route('site.user.account.profile')}}"
                                           class="change_data_view">Hồ
                                            sơ</a></li>
                                    <li><a href="" data-url="{{route('site.user.account.address')}}"
                                           class="change_data_view">Địa
                                            chỉ</a></li>
                                    <li><a href="" data-url="{{route('site.user.account.password')}}"
                                           class="change_data_view">Đổi
                                            mật khẩu</a></li>

                                </ul>
                            </li>
                            <li><a href="" data-url="{{route('site.user.purchase')}}" class="change_data_view">Đơn
                                    mua</a></li>
                            <li class="item-action"><a href="" data-url="{{route('site.user.purchase')}}" class="change_data_view">Hoạt động bình luận</a></li>
                            <li class="item-action"><a href="" data-url="{{route('site.user.purchase')}}" class="change_data_view">Sản phẩm yêu thích</a></li>
                            <li class="item-action"><a href="{{route('site.logout')}}">Thoát</a></li>
                        </ul>
                    </div>
                </div>
