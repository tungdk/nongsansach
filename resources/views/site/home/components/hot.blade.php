                                                                                ...
                                                                                <div class="price-box clearfix">
                                                                                    <div class="special-price">
                                                                                        @if($product->price == $product->sale)
                                                                                            <span style="font-size: 25px"> ₫{{number_format($product->sale, 0, ',', '.')}}</span>
                                                                                        @else
                                                                                            <del style="font-size: 15px">₫{{number_format($product->price, 0, ',', '.')}}</del><span style="font-size: 25px"> ₫{{number_format($product->sale, 0, ',', '.')}}</span>
                                                                                        @endif
                                                                                    </div>
                                                                                    <br>
