                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Thực phẩm..." value="{{ $product->name ?? old('name') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="quantity" placeholder="10" value="{{ $product->qty ?? old('qty',0) }}">
                                    </div>
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="idContent" cols="5" rows="2" class="form-control">{{ $product->info ?? '' }}</textarea>
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body block-images">
                            <div style="margin-bottom: 10px">
                                <img  src="/images/no-image.jpg" class="img-thumbnail" onerror="this.onerror=null;this.src='images/no-image.jpg'" alt="" style="width:200px; height:200px">
                            </div>
                ...
                <div class="col-sm-4">
                    <div class="box box-warning">
                        ...
                        <div class="box-body block-images add_image">
                            <div style="margin-bottom: 10px">
                                <img  src="{{url('/')}}/public/uploads/brand/" class="img-thumbnail" onerror="this.onerror=null;this.src='{{asset('images/no-image.jpg')}}" alt="" style="width:200px; height:200px">
                            </div>
                            <div style="position: relative;">
                                <a href="javascript:;" class="btn btn-primary">Choose File....
                                    <input type="file" style="position:absolute;z-index:2;top:0;left:0;opacity:0;background-color:transparent"
