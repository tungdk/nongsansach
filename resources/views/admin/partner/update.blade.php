                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->first('name' ? 'has-danger' : '') }}">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Nhập tên đối tác" value="{{$partner->name}}">
                            ...
                            <div class="form-group {{ $errors->first('logo' ? 'has-danger' : '') }}">
                                ...
                                <input type="file" class="form-control" name="logo" value="{{$partner->logo}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="status" @if(isset($partner->status) && $partner->status == 1) checked @endif>
                            </div>
                        </div>
                        <div class="col-md-12">
